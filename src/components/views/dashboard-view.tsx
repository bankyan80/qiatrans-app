          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <motion.div variants={itemVariants}>
              <Card className="h-full">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-base lg:text-lg">Booking Terbaru</CardTitle>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="gap-1 text-xs text-muted-foreground hover:text-foreground"
                ...
                <CardContent className="px-4 pb-4">
                  {loading ? (
                    ...
                    <div className="flex flex-col items-center py-8 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Belum ada booking terbaru</p>
                    </div>
                  ) : (
                ...
                <CardContent className="px-4 pb-4">
                  {loading ? (
                    ...
                    <div className="flex flex-col items-center py-8 text-center">
                      ...
                      <p className="text-sm font-medium text-emerald-600 dark:text-emerald-400">Semua Aman!</p>
                      <p className="text-xs text-muted-foreground mt-1">Tidak ada peringatan servis dalam 7 hari ke depan</p>
                    </div>
                  ) : (
                    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-2.5">
                      {maintenanceAlerts.map((alert, index) => (
                        <MaintenanceAlertItem key={alert.id} alert={alert} index={index} />
                      ))}
                    </motion.div>
                  )}
                </CardContent>
